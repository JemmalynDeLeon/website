  ...
  return (
    <>
      ...
      <section class="flex flex-col space-y-4 items-end justify-end m-6">
        ...
        {/* <blockquote class="twitter-tweet" class="flex flex-col space-y-4 items-start justify-start m-6"><p lang="en" dir="ltr">Mid-Year Commencement Exercises Schedule 🎓🎓🎓 <a href="https://t.co/QAlrfrH6bJ">pic.twitter.com/QAlrfrH6bJ</a></p>&mdash; PUP (Official) (@ThePUPOfficial) <a href="https://twitter.com/ThePUPOfficial/status/1648137053908135936?ref_src=twsrc%5Etfw">April 18, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" ></script> */}
      </section>
