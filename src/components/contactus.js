    ...
    <div className="w-full px-4 py-8 container-body ">
      <div className="flex flex-row">
        <div className="w-10/12 ">
          <h1 className="text-lg font-bold leading-7 py-4 text-left text-[29px] text-red">Contact us</h1>
          ...
          <p className="mb-7">
            <span className="text-2xl text-grey contact-span">inquire@pup.edu.ph</span>
          </p>

          <table className="mb-4 border border-collapse table-auto">
            <thead className="bg-grey">
              <tr>
                <th className="p-1 text-sm font-thin border text-gray-light ">Specific Concerns</th>
                <th className="p-1 text-sm font-thin border text-red ">E-mail</th>
              </tr>
            </thead>
            <tbody>
              ...
              <div key={index}>
                ...
                {contact.details.map((detail, index) =>
                  detail === 'Office of the University Registrar' ? (
                    <strong className="text-grey blockquote-p" key={detail}>
                      {detail}
                    </strong>
                  ) : (
