...
import { Logo, ModalLink } from "@helpers/modal_data";
                      ...
                      <div className="flex flex-col flex-wrap content-center w-full md:flex-row">
                          ...
                          <div className="modal-items-container gap-y-2 md:gap-y-1">
                              {ModalLink.map((modalLink, index)=>(
                                <a key={index} href={modalLink.link} className="modal-links-container w-full bg-red py-2.5 px-4 h-20 md:h-11 rounded-sm hover:bg-red flex-wrap content-center hover:pl-7 flex space-x-2 text-white">
